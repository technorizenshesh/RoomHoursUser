 ...
 */
public class BestMatchRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    int pos = 0;
    private Context mContext;
    private ArrayList<HomeDataModel> modelList;
    private BestMatchRecyclerViewAdapter.OnItemClickListener mItemClickListener;
    private Fragment fragment;
    boolean isLike=true;

    public BestMatchRecyclerViewAdapter(Context context, ArrayList<HomeDataModel> modelList,Fragment fragment) {
    ...
    @Override
    public BestMatchRecyclerViewAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_best_match, viewGroup, false);
        return new BestMatchRecyclerViewAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        //Here you can fill your row view
        if (holder instanceof BestMatchRecyclerViewAdapter.ViewHolder) {
            final HomeDataModel model = getItem(position);
            final BestMatchRecyclerViewAdapter.ViewHolder genericViewHolder = (BestMatchRecyclerViewAdapter.ViewHolder) holder;
    ...
    public void SetOnItemClickListener(final BestMatchRecyclerViewAdapter.OnItemClickListener mItemClickListener) {
